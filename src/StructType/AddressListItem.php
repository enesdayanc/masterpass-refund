...
class AddressListItem extends AbstractStructBase
{
     ...
     * @uses \Enesdayanc\MasterpassRefund\EnumType\AddressType::valueIsValid()
     * @uses \Enesdayanc\MasterpassRefund\EnumType\AddressType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $address_type
     * @return \Enesdayanc\MasterpassRefund\StructType\AddressListItem
     */
    public function setAddress_type($address_type = null)
    {
        // validation for constraint: enumeration
        if (!\Enesdayanc\MasterpassRefund\EnumType\AddressType::valueIsValid($address_type)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $address_type, implode(', ', \Enesdayanc\MasterpassRefund\EnumType\AddressType::getValidValues())), __LINE__);
        }
    ...
    {
        // validation for constraint: enumeration
        if (!\Enesdayanc\MasterpassRefund\EnumType\YesNoFlag::valueIsValid($defaultAddress)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $defaultAddress, implode(', ', \Enesdayanc\MasterpassRefund\EnumType\YesNoFlag::getValidValues())), __LINE__);
        }
