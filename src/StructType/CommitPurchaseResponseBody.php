...
/**
 * This class stands for CommitPurchaseResponseBody StructType
 * @subpackage Structs
 */
class CommitPurchaseResponseBody extends ConsumerFinancialResponseBody
{
    /**
     * The merchant_name
    ...
    public $token;
    /**
     * Constructor method for CommitPurchaseResponseBody
     * @uses CommitPurchaseResponseBody::setMerchant_name()
     * @uses CommitPurchaseResponseBody::setReconciliation_date()
     * @uses CommitPurchaseResponseBody::setMasked_sender_rta()
     * @uses CommitPurchaseResponseBody::setRequestOrderId()
     * @uses CommitPurchaseResponseBody::setToken()
     ...
     * @param string $merchant_name
     * @return \Enesdayanc\MasterpassRefund\StructType\CommitPurchaseResponseBody
     */
