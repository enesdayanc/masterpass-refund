...
class ConsumerAccountSearchResponseBody extends ResponseBody
{
     ...
     * - minOccurs: 0
     * - nillable: true
     * @var \Enesdayanc\MasterpassRefund\StructType\ConsumerAccount[]
     */
     ...
     * @param \Enesdayanc\MasterpassRefund\StructType\ConsumerAccount[] $consumer_accounts
     */
     ...
     * @param string $response_code
     * @return \Enesdayanc\MasterpassRefund\StructType\ConsumerAccountSearchResponseBody
     */
     ...
     * @return \Enesdayanc\MasterpassRefund\StructType\ConsumerAccount[]|null
     */
    ...
    public function setConsumer_accounts(array $consumer_accounts = array())
    {
        foreach ($consumer_accounts as $consumerAccountSearchResponseBodyConsumer_accountsItem) {
            ...
            if (!$consumerAccountSearchResponseBodyConsumer_accountsItem instanceof \Enesdayanc\MasterpassRefund\StructType\ConsumerAccount) {
                throw new \InvalidArgumentException(sprintf('The consumer_accounts property can only contain items of \Enesdayanc\MasterpassRefund\StructType\ConsumerAccount, "%s" given', is_object($consumerAccountSearchResponseBodyConsumer_accountsItem) ? get_class($consumerAccountSearchResponseBodyConsumer_accountsItem) : gettype($consumerAccountSearchResponseBodyConsumer_accountsItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \Enesdayanc\MasterpassRefund\StructType\ConsumerAccount $item
     * @return \Enesdayanc\MasterpassRefund\StructType\ConsumerAccountSearchResponseBody
     */
    public function addToConsumer_accounts(\Enesdayanc\MasterpassRefund\StructType\ConsumerAccount $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \Enesdayanc\MasterpassRefund\StructType\ConsumerAccount) {
            throw new \InvalidArgumentException(sprintf('The consumer_accounts property can only contain items of \Enesdayanc\MasterpassRefund\StructType\ConsumerAccount, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
