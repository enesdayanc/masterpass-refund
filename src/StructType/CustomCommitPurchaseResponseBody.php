...
/**
 * This class stands for CustomCommitPurchaseResponseBody StructType
 * @subpackage Structs
 */
class CustomCommitPurchaseResponseBody extends ConsumerFinancialResponseBody
{
    /**
     * The merchant_name
    ...
    public $token;
    /**
     * Constructor method for CustomCommitPurchaseResponseBody
     * @uses CustomCommitPurchaseResponseBody::setMerchant_name()
     * @uses CustomCommitPurchaseResponseBody::setReconciliation_date()
     * @uses CustomCommitPurchaseResponseBody::setMasked_sender_rta()
     * @uses CustomCommitPurchaseResponseBody::setRequestOrderId()
     * @uses CustomCommitPurchaseResponseBody::setToken()
     ...
     * @param string $merchant_name
     * @return \Enesdayanc\MasterpassRefund\StructType\CustomCommitPurchaseResponseBody
     */
