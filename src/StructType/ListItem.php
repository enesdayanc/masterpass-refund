...
class ListItem extends AbstractStructBase
{
     ...
     * @param string $list_item_value_2
     * @return \Enesdayanc\MasterpassRefund\StructType\ListItem
     */
    ...
    public function setPrompt_cpin($prompt_cpin = null)
    {
        ...
        if (!\Enesdayanc\MasterpassRefund\EnumType\YesNoFlag::valueIsValid($prompt_cpin)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $prompt_cpin, implode(', ', \Enesdayanc\MasterpassRefund\EnumType\YesNoFlag::getValidValues())), __LINE__);
        }
    ...
    {
        // validation for constraint: enumeration
        if (!\Enesdayanc\MasterpassRefund\EnumType\YesNoFlag::valueIsValid($is_masterpass_member)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $is_masterpass_member, implode(', ', \Enesdayanc\MasterpassRefund\EnumType\YesNoFlag::getValidValues())), __LINE__);
        }
