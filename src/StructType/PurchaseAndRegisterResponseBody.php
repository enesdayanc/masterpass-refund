...
/**
 * This class stands for PurchaseAndRegisterResponseBody StructType
 * @subpackage Structs
 */
class PurchaseAndRegisterResponseBody extends ConsumerFinancialResponseBody
{
    /**
     * The merchant_name
    ...
    public $token;
    /**
     * Constructor method for PurchaseAndRegisterResponseBody
     * @uses PurchaseAndRegisterResponseBody::setMerchant_name()
     * @uses PurchaseAndRegisterResponseBody::setReconciliation_date()
     * @uses PurchaseAndRegisterResponseBody::setMasked_sender_rta()
     * @uses PurchaseAndRegisterResponseBody::setRequestOrderId()
     * @uses PurchaseAndRegisterResponseBody::setToken()
     ...
     * @param string $merchant_name
     * @return \Enesdayanc\MasterpassRefund\StructType\PurchaseAndRegisterResponseBody
     */
