...
class VerifyUserResponseBody extends ResponseBody
{
     ...
     * - maxOccurs: 1
     * - minOccurs: 0
     * @var \Enesdayanc\MasterpassRefund\ArrayType\ArrayOfListItem
     */
    public $list_items;
    /**
     * The token
     ...
     * @param string $status
     * @param \Enesdayanc\MasterpassRefund\ArrayType\ArrayOfListItem $list_items
     * @param string $token
     */
    public function __construct($status = null, \Enesdayanc\MasterpassRefund\ArrayType\ArrayOfListItem $list_items = null, $token = null)
    {
        $this
            ->setStatus($status)
     ...
     * Set status value
     * @param string $status
     * @return \Enesdayanc\MasterpassRefund\StructType\VerifyUserResponseBody
     */
     ...
     * @return \Enesdayanc\MasterpassRefund\ArrayType\ArrayOfListItem|null
     */
     ...
     * @return \Enesdayanc\MasterpassRefund\StructType\VerifyUserResponseBody
     */
    public function setList_items(\Enesdayanc\MasterpassRefund\ArrayType\ArrayOfListItem $list_items = null)
    {
