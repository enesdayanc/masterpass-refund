...
class ViewListResponseBody extends ResponseBody
{
     ...
     */
    public function __construct($account_status = null, \Enesdayanc\MasterpassRefund\ArrayType\ArrayOfListItem $list_items = null)
    {
        $this
     ...
     * @param string $account_status
     * @return \Enesdayanc\MasterpassRefund\StructType\ViewListResponseBody
     */
